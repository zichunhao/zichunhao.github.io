...
<div style="text-align: center">
  <img src="/assets/img/publication_preview/jetnet-page.png" alt="JetNet logo" style="max-width: min(420px, 100%); border-radius: 8px" loading="lazy">
</div>
